...
class Customer
{
     ...
     * @Groups({"customers_read", "invoices_read", "customers_write"})
    ...
    /**
     * @ORM\OneToMany(targetEntity=MediaObject::class, cascade={"persist", "remove"}, mappedBy="customer")
    ...
    /**
     * Permet de récuperer le montant non payé (montant total hors factures non payées ou annulées).
     * @Groups({"customers_read"})
     * @return float
     */
